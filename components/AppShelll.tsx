...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full" style={{ background: "#f1f2f4" }}>
      <header className="h-12 sticky top-0 z-50 flex items-center px-4 gap-3 shrink-0" style={{ background: "#0052cc" }}>
        <Link href="/tasks" className="flex items-center gap-2 font-bold text-white text-lg tracking-tight">
